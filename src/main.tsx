...
//
// The custom theme's tokens are replayed from the same cache, which matters
// more here than the preference does: a branded window opening in the shipped
// cyan and turning violet a round trip later moves a whole palette, where the
// preference only ever moves one of two.
applyCachedTheme();
